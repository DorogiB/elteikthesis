...
\begin{figure}[H]
	...
	\label{fig:picture-5}
\end{figure}\todo{Ez a 2. ábra kicsit torzítottnak tűnik?}
...
\todo[inline]{Itt számít, hogy konkrétan Shapefile vagy csak annyi, hogy fájlba mentett?\\
Számít, ugyanis shapefile esetén más a feature id-k kezelése\\
Mi történik ha pl. GML formátumban mentjük az adatokat?}
\end{note}
